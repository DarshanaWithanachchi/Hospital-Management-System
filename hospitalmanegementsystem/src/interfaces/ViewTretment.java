...
import queries.Search_Tretment;

/**
 *
 * @author User
 */
public class ViewTretment extends javax.swing.JFrame {

    /**
     * Creates new form ViewTretment
     */
    public ViewTretment() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Enter Patient Name"));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtdoctor1, javax.swing.GroupLayout.DEFAULT_SIZE, 172, Short.MAX_VALUE)
                    .addComponent(jButton1, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(txtpatientname1, javax.swing.GroupLayout.DEFAULT_SIZE, 172, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       String id = txtpatientid1.getText();
       int iid = Integer.parseInt(id);

        Search_Tretment st = new Search_Tretment();

        TretmentDetails vp = Search_Tretment.sechTretmentDetails(iid);

        txtpatientname1.setText(vp.getPaientname());
        txttest1.setText(vp.getIdtest() + "");
        txtdoctor1.setText(vp.getDoctor());
        txttretment.setText(vp.getTretment());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewTretment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewTretment().setVisible(true);
            }
        });
    }
