...
public class Nurse extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Enter Nurse Details"));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtcontactno, javax.swing.GroupLayout.DEFAULT_SIZE, 228, Short.MAX_VALUE)
                            .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    DBOperationNurse dbon = new DBOperationNurse();

    private void btnsubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsubmitActionPerformed
         // create in instance of the entity class
        
        NurseDetails nud = new NurseDetails();

        nud.setIdnurse(0);
        nud.setIdward(Integer.parseInt(txtwardno.getText()));
        nud.setFirstname(txtfirstname.getText());
        nud.setLastname(txtlastname.getText());
        nud.setNicno(txtnicno.getText());
        nud.setAddress(txtaddress.getText());
        nud.setSex(cmbsex.getSelectedItem().toString());
        nud.setAge(Integer.parseInt(txtage.getText().toString()));
        nud.setContactno(Integer.parseInt(txtcontactno.getText().toString()));

        boolean result = dbon.addNurse(nud);
        if (result) {
